...
def upload_file():
    ...
    try:
        ...
        return send_file(output.read(), download_name="accounting.xlsx", mimetype="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", as_attachment=True)
